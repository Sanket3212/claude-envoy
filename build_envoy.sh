...
# Maintainer    : (ported from v1.34.0 work by Sumit Dubey <Sumit.Dubey2@ibm.com>)
#
...
#
# Key differences from v1.34.0 build:
#   - Bazel 7.6.0 (was 7.4.x in v1.34.0)
#   - Python 3.11.9 (rules_python prebuilt binary available for ppc64le)
#   - rules_go downgraded to 0.46.0 (prebuilt binary available for ppc64le)
#   - rules_rust 0.56.0 (already has upstream ppc64le patch)
#   - aws-lc removed (no ppc64le support in aws-lc)
#   - BoringSSL patched for ppc64 target detection
#   - v8_ppc64le.patch already in upstream v1.35.0 (no need to carry it)
#
# ----------------------------------------------------------------------------

PACKAGE_NAME=envoy
PACKAGE_ORG=envoyproxy
SCRIPT_PACKAGE_VERSION=v1.35.0
...
#Build cargo-bazel native binary for powerpc64le
# rules_rust is at version 0.56.0 in v1.35.0
cd $wdir
